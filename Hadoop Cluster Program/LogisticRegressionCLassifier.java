...
public class LogisticRegressionCLassifier {
	...
	public static void main(String[] args) {
		...
		SparkSession spark = SparkSession.builder()
				//.master("local")
				.appName("Logistic Regression").getOrCreate();
		/**
		...
		long seed = (null != args && args[1].isEmpty()) ? 1 : Long.parseLong(args[1]);
		/**
		 ...
		 */
		LogisticRegression lr = new LogisticRegression().setLabelCol("indexedLabel").setFeaturesCol("indexedFeatures")
